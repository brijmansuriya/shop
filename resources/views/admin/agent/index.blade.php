...
@section('breadcrumb')
    ...
    <div class="topbar-right">
        <a href="{{ url('admin/agent/add') }}" class="btn btn-default btn-sm light fw600 ml10">
                ...
                <div class="panel panel-visible" id="spy2">
                    <div class="panel-heading">
                        <div class="panel-title hidden-xs">
                            <span class="glyphicon glyphicon-tasks"></span>{{ $page }}
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($agentdata as $list)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ url('admin/agent/add/') }}/{{ $list->id }}"
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a data-id="{{ $list->id }}" data-action="#"
                                                onclick="deleteConfirmation({{ $list->id }})"> <button
    ...
    function deleteConfirmation(id) {
        swal({
            ...
            if (e.value === true) {
                ...
                window.location.href = "{{ url('admin/agent/delete/') }}/" + id
