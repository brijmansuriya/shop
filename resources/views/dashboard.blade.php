                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 pln br-r mvn15">
                                            <h5 class="ml5 mt20 ph10 pb5 br-b fw600">Visitors
                                                <small class="pull-right fw600">13,253<span class="text-primary">(8,251
                                                        unique)</span></small>
                                            </h5>
                                            <div id="high-column2" class="highchart-wrapper"
                                                style="width: 100%; height: 255px; margin: 0 auto"></div>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 admin-grid">
                                ...
                                <div class="panel-body pn">
                                    <div class="row table-layout">
                                        <div class="col-xs-5 va-m">
                                            <div id="high-column" class="highchart-wrapper"
                                                style="width: 100%; height: 197px; margin: 0 auto"></div>
                                        </div>
                                            ...
                                            <table class="table mbn tc-med-1 tc-bold-last">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="fa fa-circle text-warning fs14 mr10"></span>Behance
                                                        </td>
                                                        <td>24%</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="fa fa-circle text-info fs14 mr10"></span>Twitter
                                                        </td>
                                                        <td>7%</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="fa fa-circle text-primary fs14 mr10"></span>Facebook
                                                        </td>
                                                        <td>14%</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="fa fa-circle text-alert fs14 mr10"></span>Dribble
                                                        </td>
                                                        <td>21%</td>
                                                    </tr>
                                                </tbody>
                            ...
                            <div class="panel" id="p7">
                                ...
                                <div class="panel-body pn">
                                    <div class="br-b admin-form">
                                        <div class="smart-widget sm-right smr-50">
                                            <label class="field">
                                                <input type="text" name="sub" id="sub" class="gui-input br-n"
                                        ...
                                        <table class="table mbn br-t">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="va-m fw600 text-muted">
                                                        <span
                                                            class="fa fa-female text-primary fs14 ml5 mr10"></span>Male
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="va-m fw600 text-muted">
                                                        <span
                                                            class="fa fa-child text-warning fs15 ml5 mr10"></span>Unemployed
                                                    </td>
                                    ...
                                    <div id="high-line3" class="highchart-wrapper"
                                        style="width: 100%; height: 210px; margin: 0 auto"></div>
                                </div>
                            </div>
                            ...
                            <div class="panel" id="p10">
                                ...
                                <div class="panel-body pn">
                                    <div id="high-pie" class="highchart-wrapper"
                                ...
                                <div class="panel-body pn">
                                    <div class="row table-layout">
                                        <div class="col-xs-4 text-center posr">
                                            <span data-toggle="tooltip" data-placement="top" title="Missouri"
                                                class="stateface stateface-mo fs70 text-info light t-center"></span>
                                        </div>
                                        <div class="col-xs-8 br-l pn admin-form">
                                            <div class="smart-widget sm-right smr-50">
                                                <label class="field">
                                                    <input type="text" name="sub" id="sub" class="gui-input br-n br-b"
                                                        placeholder="Search State">
                                                </label>
                                                <button type="submit" class="button br-n br-b br-l">
                                                    <i class="fa fa-caret-down"></i>
                                            ...
                                            <table class="table mbn">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="va-m fw600 text-muted">
                                                            <span
                                                                class="fa fa-female text-primary fs14 mr10"></span>Male
                                                        </td>
                                                        <td class="fs14 fw600 text-right">54%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="va-m fw600 text-muted">
                                                            <span class="fa fa-male text-info fs14 mr10"></span>Female
                                                        </td>
                                                        <td class="fs14 fw600 text-right">46%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="va-m fw600 text-muted">
                                                            <span
                                                                class="fa fa-child text-warning fs15 mr10"></span>Unemployed
                                                        </td>
                                                        <td class="fs14 fw600 text-right">14%</td>
                                                    </tr>
                                                </tbody>
                                ...
                                <div class="panel-body pn">
                                    <table class="table mbn">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="va-m fw600 text-muted">
                                                    <span class="fa fa-circle text-alert fs14 mr10"></span>New York
                                                </td>
                                            ...
                                            <tr>
                                                <td class="va-m fw600 text-muted">
                                                    <span class="fa fa-circle text-warning fs14 mr10"></span>California
                                                </td>
                        ...
                        <div class="col-md-6 col-lg-4 admin-grid">
                            ...
                            <div class="panel" id="p11">
                                ...
                                <div class="panel-body pbn">
                                    <div id="high-column3" class="highchart-wrapper"
                                ...
                                <div class="panel-footer p15">
                                    <p class="text-muted text-center mbn">A percent measure of tickets with
                                        <b class="text-info">first</b> reply time
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4 text-center">
                                            <div class="info-circle" id="c1" value="80" data-circle-color="primary">
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                        ...
                                        <div class="col-xs-4">
                                            <div class="info-circle" id="c3" value="55" data-circle-color="warning">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel" id="p12">
                                ...
                                <div class="panel-body pn">
                                    <div id="high-bars" class="highchart-wrapper"
                                    ...
                                    <table class="table mbn">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="fw600 text-muted">Desktop Viewers
                                                </td>
                                                <td>
                                                    <span class="inlinesparkline pull-right" data-spark-color="warning"
                                                        values="5,6,7,9,9,5,3,2,2,4,6"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="fw600 text-muted">Tablet Viewers
                                                </td>
                                                <td>
                                                    <span class="inlinesparkline pull-right" data-spark-color="info"
                                                        values="4,6,7,9,9,5,3,2,2,4,6,7"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="fs18 text-center">
                                                ...
                                                <td class="fw600 text-muted">Customer Support
                                                </td>
                                                <td>
                                                    <span class="inlinesparkline pull-right" data-spark-color="primary"
                                                        values="7,3,2,2,4,6,7,6,7,9"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="fs18 text-center">
                                                ...
                                                <td class="fw600 text-muted">Rocket Explosions
                                                </td>
                                                <td>
                                                    <span class="inlinesparkline pull-right" data-spark-color="alert"
                                                        values="2,6,7,9,9,5,3,2,2,4,6,7"></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="panel" id="p14">
                                ...
                                <div class="panel-menu">
                                    <div class="chart-legend" data-chart-id="#high-area">
                                        <a data-chart-id="0" class="legend-item btn btn-sm btn-warning ph20 mr10">Data
                                            1</a>
                                ...
                                <div class="panel-body pn">
                                    <div id="high-area" class="highchart-wrapper"
                                        style="width: 100%; height: 230px; margin: 0 auto"></div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body pn">
                                    <table class="table mbn tc-med-1 tc-bold-last">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="fa fa-circle text-warning fs14 mr10"></span>Behance
                                                </td>
                                                <td>24%</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="va-m fw600 text-muted">
                                                    <span class="fa fa-circle text-primary fs14 mr10"></span>Facebook
                                                </td>
                                                <td>14%</td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="panel-body pn">
                                    <table class="table mbn tc-med-1 tc-bold-last">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="favicons google va-t mr10"></span>pages.com/article/7
                                                </td>
                                                <td>24%</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="favicons bing va-t mr10"></span>pages.com/featured/16
                                                </td>
                                                <td>22%</td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="panel-body pn">
                                    <table class="table mbn tc-med-1 tc-bold-2">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="favicons chrome va-t mr10"></span>United States
                                                </td>
                                                <td>39%</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="panel-body pn">
                                    <table class="table mbn tc-med-1 tc-bold-last ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="fa fa-circle text-alert fs14 mr10"></span>Google Plus
                                                </td>
                                                <td>24%</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="panel-body pn">
                                    <table class="table mbn tc-list-1 tc-text-muted-2 tc-fw600-2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>2.</td>
                                                <td>Lorem ipsc beyond ray
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>3.</td>
                                                <td>Amet, consectetur adipi
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>4.</td>
                                                <td>Lorem consec iscing
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
